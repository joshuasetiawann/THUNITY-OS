...
#define THUOS_VERSION      "0.7.0"
#define THUOS_CODENAME     "Virtual Memory"
#define THUOS_MILESTONE    "Milestone 0.7 - Paging ENABLED (CR0.PG, identity map), boot-verified in QEMU"
