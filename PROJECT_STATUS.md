...
**Milestone:** 0.17 "Suite" — a Settings menu (themes/display/devices) plus Notes and Paint apps, boot-verified in QEMU (CI)
...
| **Settings menu (themes/display/devices/about) + Notes + Paint apps** | **Boot-verified (QEMU/CI) + screenshot** | `kernel/gui/apps.c`; live theme switch via `desktop_set_theme`; Notes autosaves to ramfs |
