...
**Milestone:** 0.3 "Memory Foundation" — Physical Memory Manager
...
| Shell (`thuos>`, 21 commands) | Implemented | `kernel/shell/shell.c` |
...
| Kernel heap (`kmalloc`/`kfree`) | Designed | `docs/11_KERNEL_HEAP_PLAN.md` |
